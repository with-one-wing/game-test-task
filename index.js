...
const randomString = () => 'customer' + Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
...
const createBubbleElement = (bubble, xArea, yArea, onBubbleClick) => {
    let color = 'yellow';
